...
BEGIN {
    *CLASS = \'eleMentalClinic::Role::DirectClientPermission';
    use_ok( $CLASS );
}
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# table info
    is( $one->table, 'direct_client_permission');
    is( $one->primary_key, 'rec_id');
    is_deeply( $one->fields, [qw/ rec_id role_id client_id /]);
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    lives_ok { $CLASS->new({ role_id => 1, client_id => 1001 })->save }
        "Can save new permission";
